package ru.johnlife.uilibrary.widget.customviews.playpause;
...
public class PlayPauseView extends View {
	...
	public PlayPauseView(Context context, AttributeSet attrs) {
		...
		mPauseBarWidth = Utils.dpToPx(context, (int) attributes.getInteger(R.styleable.PlayPauseButton_pauseBarWidth, DEFAULT_WIDTH));
		mPauseBarHeight = Utils.dpToPx(context, (int) attributes.getInteger(R.styleable.PlayPauseButton_pauseBarHeight, DEFAULT_HEIGHT));
		mPauseBarDistance = Utils.dpToPx(context, (int) attributes.getInteger(R.styleable.PlayPauseButton_pauseBarDistance, DEFAULT_DISTANCE));
