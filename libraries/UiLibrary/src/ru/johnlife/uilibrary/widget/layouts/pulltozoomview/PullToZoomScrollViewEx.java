...
//    private static final String TAG = PullToZoomScrollViewEx.class.getSimpleName();
    private boolean isCustomHeaderHeight = false;//РёвЂЎР„РµВ®С™Рґв„–вЂ°headerР№В«пїЅРµС”В¦Рґв„–вЂ№РµС’Р‹РµРЏР‡РёС“Р…РµР‡С�РёвЂЎТ‘zoomViewР¶вЂ№вЂ°РґС�С‘РґС‘РЊР¶В­Р€Р·РЋВ®
...
//        Log.d(TAG, "smoothScrollToTop --> ");
    ...
    /**
     * РёВ®С•Р·Р…В®HeaderView LayoutParams
     *
