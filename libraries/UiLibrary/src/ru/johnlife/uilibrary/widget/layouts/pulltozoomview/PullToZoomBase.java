...
public abstract class PullToZoomBase<T extends View> extends LinearLayout implements IPullToZoom<T> {
    ...
    protected View mHeaderView;//РµВ¤Т‘Р№С“РЃView
    protected View mZoomView;//Р·С�В©Р¶вЂќС•Р¶вЂ№вЂ°РґС�С‘View
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            //Рµв‚¬СњРµВ§вЂ№РµРЉвЂ“Р·Р‰В¶Р¶Р‚РѓView
    ...
    public void setHideHeader(boolean isHideHeader) {//headerР¶пїЅС•Р·В¤С”Р¶вЂ°РЊРёС“Р…Zoom
