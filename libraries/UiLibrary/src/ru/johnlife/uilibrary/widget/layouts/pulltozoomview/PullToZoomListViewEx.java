package ru.johnlife.uilibrary.widget.layouts.pulltozoomview;
...
//    private static final String TAG = PullToZoomListViewEx.class.getSimpleName();
    ...
    /**
     * Р¶пїЅР‡РµС’В¦Р¶пїЅС•Р·В¤С”headerView
     *
    ...
    /**
     * Р·В§В»Р№в„ўВ¤HeaderView
     * РµВ¦вЂљР¶С›СљРёВ¦РѓРµвЂ¦С�РµВ®в„–API 9,Р№СљР‚РёВ¦РѓРґС—В®Р¶вЂќв„–Р¶В­В¤РµВ¤вЂћР№Р‚В»РёС•вЂ�РїС�РЉAPI 11РґВ»ТђРґС‘вЂ№РґС‘РЊР¶вЂќР‡Р¶РЉРѓРµР‰РЃР¶Р‚РѓР¶В·В»РµР‰В header
     */
    ...
    /**
     * Р¶вЂєТ‘Р¶вЂ“В°HeaderView  РµвЂ¦в‚¬Р·В§В»Р№в„ўВ¤-->РµвЂ РЊР¶В·В»РµР‰В zoomViewРіР‚РѓHeaderView -->Р·вЂћВ¶РµС’Р‹Р¶В·В»РµР‰В Рµв‚¬В°listViewР·С™вЂћhead
     * РµВ¦вЂљР¶С›СљРёВ¦РѓРµвЂ¦С�РµВ®в„–API 9,Р№СљР‚РёВ¦РѓРґС—В®Р¶вЂќв„–Р¶В­В¤РµВ¤вЂћР№Р‚В»РёС•вЂ�РїС�РЉAPI 11РґВ»ТђРґС‘вЂ№РґС‘РЊР¶вЂќР‡Р¶РЉРѓРµР‰РЃР¶Р‚РѓР¶В·В»РµР‰В header
     */
    ...
    /**
     * Рµв‚¬вЂєРµВ»С”listView РµВ¦вЂљР¶С›СљРёВ¦РѓРµвЂ¦С�РµВ®в„–API9,Р№СљР‚РёВ¦РѓРґС—В®Р¶вЂќв„–Р¶В­В¤РµВ¤вЂћ
     *
     * @param context РґС‘Р‰РґС‘вЂ№Р¶вЂ“вЂЎ
    ...
    /**
     * Р№вЂЎРЊР·Р…В®РµР‰РЃР·вЂќВ»РїС�РЉРёвЂЎР„РµР‰РЃР¶В»вЂ�РµР‰РЃРµв‚¬В°Р№РЋВ¶Р№С“РЃ
     */
    @Override
...
//        Log.d(TAG, "smoothScrollToTop --> ");
    ...
    /**
     * zoomViewРµР‰РЃР·вЂќВ»Р№Р‚В»РёС•вЂ�
     *
     * @param newScrollValue Р¶вЂ°вЂ№Р¶РЉвЂЎYРёР…Т‘Р·В§В»РµР‰РЃРёВ·СњР·В¦В»РµР‚С�
     */
    @Override
...
//        Log.d(TAG, "pullHeaderToZoom --> mHeaderHeight = " + mHeaderHeight);
    ...
    /**
     * РёВ®С•Р·Р…В®HeaderViewР№В«пїЅРµС”В¦
     *
     * @param width  РµВ®Р…
     * @param height Р№В«пїЅ
     */
