...
import ru.johnlife.uilibrary.widget.customviews.CustomView;
		...
		try {
			for (int i = 0; i < attrs.getAttributeCount(); i++) {
				if (attrs.getAttributeName(i).equals(BACKGROUND)) {
					bacgroundColor = Utils.getResIdFromAttribute((Activity) getContext(), Integer.parseInt(attrs.getAttributeValue(i).replace("?", "")));
				}
			}
		} catch (Exception e) {
