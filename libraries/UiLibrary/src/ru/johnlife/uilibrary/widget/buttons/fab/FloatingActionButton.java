package ru.johnlife.uilibrary.widget.buttons.fab;
...
public class FloatingActionButton extends ImageButton {
	...
	private void init(Context context, AttributeSet attributeSet) {
		mVisible = true;
		mColorNormal = getColor(R.color.material_accent);
		mColorPressed = getColor(R.color.material_accent_dark);
	...
	private void initAttributes(Context context, AttributeSet attributeSet) {
		...
		if (attr != null) {
			try {
				mColorNormal = attr.getColor(R.styleable.FloatingActionButton_fab_colorNormal, getColor(R.color.material_accent));
				mColorPressed = attr.getColor(R.styleable.FloatingActionButton_fab_colorPressed, getColor(R.color.material_accent_dark));
