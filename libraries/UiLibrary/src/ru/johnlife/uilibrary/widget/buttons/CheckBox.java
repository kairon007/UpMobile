package ru.johnlife.uilibrary.widget.buttons;
...
public class CheckBox extends CompoundButton {
	...
	public CheckBox(Context context, AttributeSet attrs, int defStyle) {
		...
		mColor = attributes.getColor(R.styleable.CheckBox_checkbox_color, getResources().getColor(R.color.material_primary));
		mCheckedColor = attributes.getColor(R.styleable.CheckBox_checkbox_checked_color, getResources().getColor(R.color.material_accent));
		attributes.recycle();
