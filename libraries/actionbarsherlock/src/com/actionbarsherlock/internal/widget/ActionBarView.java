...
public class ActionBarView extends AbsActionBarView {
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SherlockActionBar,
                R.attr.actionBarStyleABS, 0);

        ApplicationInfo appInfo = context.getApplicationInfo();
        PackageManager pm = context.getPackageManager();
        mNavigationMode = a.getInt(R.styleable.SherlockActionBar_navigationModeABS,
        ...
        final int homeResId = a.getResourceId(
                R.styleable.SherlockActionBar_homeLayoutABS,
        ...
        mIndeterminateProgressStyle = a.getResourceId(
                R.styleable.SherlockActionBar_indeterminateProgressStyleABS, 0);

        mProgressBarPadding = a.getDimensionPixelOffset(R.styleable.SherlockActionBar_progressBarPaddingABS, 0);
        ...
        final int customNavId = a.getResourceId(R.styleable.SherlockActionBar_customNavigationLayoutABS, 0);
        if (customNavId != 0) {
