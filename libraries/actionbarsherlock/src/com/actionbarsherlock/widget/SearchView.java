...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    */
    ...
    public SearchView(Context context, AttributeSet attrs) {
        ...
        setIconifiedByDefault(a.getBoolean(R.styleable.SherlockSearchView_iconifiedByDefaultABS, true));
        int maxWidth = a.getDimensionPixelSize(R.styleable.SherlockSearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        CharSequence queryHint = a.getText(R.styleable.SherlockSearchView_queryHintABS);
    ...
    private int getSearchIconId() {
        ...
        getContext().getTheme().resolveAttribute(R.attr.searchViewSearchIconABS,
                outValue, true);
