 ...
 */
public abstract class BaseAdapterDecorator extends BaseAdapter implements SectionIndexer, Swappable, Insertable<Object>, ListViewWrapperSetter {
    ...
    public void add(final int index, @NonNull final Object item) {
        if (mDecoratedBaseAdapter instanceof Insertable) {
            ...
            ((Insertable<Object>) mDecoratedBaseAdapter).add(index, item);
        } else {
