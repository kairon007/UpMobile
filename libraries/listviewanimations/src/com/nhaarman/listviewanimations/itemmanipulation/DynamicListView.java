...
public class DynamicListView extends ListView {
    ...
    public boolean dispatchTouchEvent(@NonNull final MotionEvent event) {
        if (mCurrentHandlingTouchEventHandler == null) {
			...
			if (event.getActionMasked() == MotionEvent.ACTION_UP || event.getActionMasked() == MotionEvent.ACTION_CANCEL) { /* Gesture is finished, reset the active TouchEventHandler */
				mCurrentHandlingTouchEventHandler = null;
			}
    ...
    public void fling(final int position, Object o) {
        if (mSwipeTouchListener != null) {
            mSwipeTouchListener.fling(position, o);
        }
    }
    ...
    public void dismiss(final int position, Object o) {
        if (mSwipeTouchListener != null) {
            if (mSwipeTouchListener instanceof SwipeDismissTouchListener) {
                ((SwipeDismissTouchListener) mSwipeTouchListener).dismiss(position, o);
            } else {
    ...
    public void undo(@NonNull final View view) {
        if (mSwipeTouchListener != null) {
            if (mSwipeTouchListener instanceof SwipeUndoTouchListener) {
                ((SwipeUndoTouchListener) mSwipeTouchListener).undo(view, getItemAtPosition(AdapterViewUtil.getPositionForView(this, view)));
            } else {
