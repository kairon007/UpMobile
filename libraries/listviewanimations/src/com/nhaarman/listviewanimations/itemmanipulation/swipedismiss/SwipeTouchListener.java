...
public abstract class SwipeTouchListener implements View.OnTouchListener, TouchEventHandler {
    ...
    public void fling(final int position, Object o) {
        ...
        flingView(downView, position, true, o);
    ...
    private void flingCurrentView(final boolean flingToRight) {
        if (mCurrentView != null) {
            flingView(mCurrentView, mCurrentPosition, flingToRight, getListViewWrapper().getAdapter().getItem(mCurrentPosition));
        }
    }
     ...
     * @param o 
     */
    private void flingView(@NonNull final View view, final int position, final boolean flingToRight, Object o) {
        if (mViewWidth < 2) {
            mViewWidth = mListViewWrapper.getListView().getWidth();
        }
        ...
        animatorSet.addListener(new FlingAnimatorListener(view, position, o));
        animatorSet.start();
    }
     ...
     * @param position the position of the item in the {@link android.widget.ListAdapter} corresponding to the {@code View}.
     */
    protected abstract void afterViewFling(@NonNull View view, int position, Object o);
    ...
    private class FlingAnimatorListener extends AnimatorListenerAdapter {
        ...
        private FlingAnimatorListener(@NonNull final View view, final int position, Object o) {
            mView = view;
            mPosition = position;
			this.o = o;
        }
        ...
        public void onAnimationEnd(@NonNull final Animator animation) {
            mActiveSwipeCount--;
            afterViewFling(mView, mPosition, o);
        }
    }
