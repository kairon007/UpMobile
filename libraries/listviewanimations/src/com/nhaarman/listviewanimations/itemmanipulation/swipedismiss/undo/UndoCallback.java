...
public interface UndoCallback extends OnDismissCallback {
     ...
     */
    void onUndoShown(@NonNull View view, int position, Object o);
     ...
     */
    void onUndo(@NonNull View view, int position, Object o);
     ...
     */
    void onDismiss(@NonNull View view, int position, Object o);
}
