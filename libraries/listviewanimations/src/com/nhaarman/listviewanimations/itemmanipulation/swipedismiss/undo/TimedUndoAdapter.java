...
public class TimedUndoAdapter extends SimpleSwipeUndoAdapter {
    ...
    public void onUndoShown(@NonNull final View view, final int position, Object o) {
        ...
        TimeoutRunnable timeoutRunnable = new TimeoutRunnable(position, o);
    ...
    public void dismiss(final int position, Object o) {
        super.dismiss(position, o);
        cancelCallback(position, o);
    }

    private void cancelCallback(final int position, Object o) {
    ...
    private class TimeoutRunnable implements Runnable {
        ...
        TimeoutRunnable(final int position, Object o) {
            mPosition = position;
			this.setO(o);
        }
