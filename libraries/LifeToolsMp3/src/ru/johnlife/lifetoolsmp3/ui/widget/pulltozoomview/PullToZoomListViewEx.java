package ru.johnlife.lifetoolsmp3.ui.widget.pulltozoomview;
...
//    private static final String TAG = PullToZoomListViewEx.class.getSimpleName();
    ...
    /**
     * з§»й™¤HeaderView
     * е¦‚жћњи¦Ѓе…је®№API 9,йњЂи¦Ѓдї®ж”№ж­¤е¤„йЂ»иѕ‘пјЊAPI 11д»Ґдё‹дёЌж”ЇжЊЃеЉЁжЂЃж·»еЉ header
     */
    ...
    /**
     * ж›ґж–°HeaderView  е…€з§»й™¤-->е†Ќж·»еЉ zoomViewгЂЃHeaderView -->з„¶еђЋж·»еЉ е€°listViewзљ„head
     * е¦‚жћњи¦Ѓе…је®№API 9,йњЂи¦Ѓдї®ж”№ж­¤е¤„йЂ»иѕ‘пјЊAPI 11д»Ґдё‹дёЌж”ЇжЊЃеЉЁжЂЃж·»еЉ header
     */
    ...
    /**
     * е€›е»єlistView е¦‚жћњи¦Ѓе…је®№API9,йњЂи¦Ѓдї®ж”№ж­¤е¤„
     *
     * @param context дёЉдё‹ж–‡
    ...
    /**
     * й‡ЌзЅ®еЉЁз”»пјЊи‡ЄеЉЁж»‘еЉЁе€°йЎ¶йѓЁ
     */
    @Override
...
//        Log.d(TAG, "smoothScrollToTop --> ");
     ...
     * zoomViewеЉЁз”»йЂ»иѕ‘
     *
     * @param newScrollValue ж‰‹жЊ‡YиЅґз§»еЉЁи·ќз¦»еЂј
     */
    @Override
