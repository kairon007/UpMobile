...
public class SmoothProgressBar extends ProgressBar {
	...
	public SmoothProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		final int color = a.getColor(R.styleable.SmoothProgressBar_spb_color, res.getColor(R.color.material_primary));
		...
		final int separatorLength = a.getDimensionPixelSize(
