	...
	public static class Builder {
		...
		private void addButtonsCallback() {
			if (positiveDialogListener != null
					|| negativeDialogListener != null) {
				builder.callback(new MaterialDialog.ButtonCallback() {
					@Override
					public void onNeutral(MaterialDialog dialog) {
						if (neutralDialogListener != null) {neutralDialogListener.onClick(dialog, DialogInterface.BUTTON_NEUTRAL);
						}
					}
		 ...
		 *            are supplied it's up to the user to dismiss the dialog. * @return
		 * @return This
		 */
		...
		public Builder setSingleChoiceItems(@NonNull String[] items, int checkedItem, final DialogInterface.OnClickListener listener) {
			builder.items(items);
			builder.itemsCallbackSingleChoice(checkedItem,
