...
public class CheckBox extends CompoundButton {
	...
	public CheckBox(Context context, AttributeSet attrs, int defStyle) {
		...
		mColor = attributes.getColor(R.styleable.CheckBox_checkbox_color, getResources().getColor(R.color.main_color_500));
		mCheckedColor = attributes.getColor(R.styleable.CheckBox_checkbox_checked_color, getResources().getColor(R.color.main_color_accent));
		attributes.recycle();
