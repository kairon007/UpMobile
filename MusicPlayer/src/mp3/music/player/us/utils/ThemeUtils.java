...
public class ThemeUtils {
    ...
    public ThemeUtils(final Context context) {
        ...
        mThemePackage = getThemePackageName(context);
        ...
        try {
            ...
            // Apollo's.
            setThemePackageName(context.getPackageName());
        }
     ...
     */
    public final String getThemePackageName(Context context) {
        return mPreferences.getString(PACKAGE_NAME, context.getPackageName());
    }
