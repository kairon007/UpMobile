...
public final class BitmapUtils {
    ...
    public static final Bitmap createBlurredBitmap(final Bitmap sentBitmap) {
        ...
        Bitmap.Config configuration;
        if(sentBitmap.getConfig() == null) {
        	configuration = Bitmap.Config.ARGB_8888;
        } else {
        	configuration = sentBitmap.getConfig();
        }
        
        final Bitmap mBitmap = sentBitmap.copy(configuration, true);
