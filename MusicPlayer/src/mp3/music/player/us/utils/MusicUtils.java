...
import mp3.music.player.us.loaders.PlaylistLoader;
...
import mp3.music.player.us.provider.FavoritesStore.FavoriteColumns;
		...
		if (null != name) {
			cursor = context.getContentResolver().
					query(MediaStore.Audio.Albums.EXTERNAL_CONTENT_URI,
						  new String[] { BaseColumns._ID }, AlbumColumns.ALBUM + "=?",
						  new String[] { name },
						  AlbumColumns.ALBUM);
		} 
        if (cursor != null) {
