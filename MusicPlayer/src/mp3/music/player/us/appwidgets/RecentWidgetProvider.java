...
public class RecentWidgetProvider extends AppWidgetProvider {
    ...
    public static final String CLICK_ACTION = "mp3.music.player.us.recents.appwidget.action.CLICK";

    public static final String REFRESH_ACTION = "mp3.music.player.us.recents.appwidget.action.REFRESH";
