...
public class MusicPlaybackService extends Service {
     ...
     */
    public static final String PLAYSTATE_CHANGED = "mp3.music.player.us.playstatechanged";

    /**
     * Indicates the meta data has changed in some way, like a track change
     */
    public static final String META_CHANGED = "mp3.music.player.us.metachanged";

    /**
     * Indicates the queue has been updated
     */
    public static final String QUEUE_CHANGED = "mp3.music.player.us.queuechanged";

    /**
     * Indicates the repeat mode chaned
     */
    public static final String REPEATMODE_CHANGED = "mp3.music.player.us.repeatmodechanged";

    /**
     * Indicates the shuffle mode chaned
     */
    public static final String SHUFFLEMODE_CHANGED = "mp3.music.player.us.shufflemodechanged";

    /**
     * Called to indicate a general service commmand. Used in
     * {@link MediaButtonIntentReceiver}
     */
    public static final String SERVICECMD = "mp3.music.player.us.musicservicecommand";

    /**
     * Called to go toggle between pausing and playing the music
     */
    public static final String TOGGLEPAUSE_ACTION = "mp3.music.player.us.togglepause";

    /**
     * Called to go to pause the playback
     */
    public static final String PAUSE_ACTION = "mp3.music.player.us.pause";

    /**
     * Called to go to stop the playback
     */
    public static final String STOP_ACTION = "mp3.music.player.us.stop";

    /**
     * Called to go to the previous track
     */
    public static final String PREVIOUS_ACTION = "mp3.music.player.us.previous";

    /**
     * Called to go to the next track
     */
    public static final String NEXT_ACTION = "mp3.music.player.us.next";

    /**
     * Called to change the repeat mode
     */
    public static final String REPEAT_ACTION = "mp3.music.player.us.repeat";

    /**
     * Called to change the shuffle mode
     */
    public static final String SHUFFLE_ACTION = "mp3.music.player.us.shuffle";

    /**
     * Called to kill the notification while Apollo is in the foreground
     */
    public static final String KILL_FOREGROUND = "mp3.music.player.us.killforeground";

    /**
     * Used to easily notify a list that it should refresh. i.e. A playlist
     * changes
     */
    public static final String REFRESH = "mp3.music.player.us.refresh";

    /**
     * Called to build the notification while Apollo is in the background
     */
    public static final String START_BACKGROUND = "mp3.music.player.us.startbackground";

    /**
     * Called to update the remote control client
     */
    public static final String UPDATE_LOCKSCREEN = "mp3.music.player.us.updatelockscreen";
