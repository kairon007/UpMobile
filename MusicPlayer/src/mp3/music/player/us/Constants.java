...
public class Constants {
	...
	public static final String EXTRA_SEARCH = "mp3.music.player.us.extra.search";
	...
	public static final String KEY_EXTRA_SEARCH = "key_extra_search";
	public static final String WHITE_THEME = "Apollo.Theme.Light";
}
