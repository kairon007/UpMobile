...
public class Settings {
	...
	public static int REMOTE_SETTINGS_MIN_UPDATE_INTERVAL_MILLIS = 9999999;// 30000;
																			// //28800000;
	...
	// "mitchie rikzu", "razzykill", "ana carolina", "renato russo",
	// "tom jobim", "jobim", "marisa monte", "monte", "marisa", "renato russo",
	// "renato", "russo", "michel telo", "telo", "elis regina", "elis",
	// "caetano veloso", "caetano", "veloso", "chico buarque", "buarque",
	// "andre matos", "matos", "andre", "gilberto gil", "gilberto",
	// "joao gilberto", "joao", "ivete sangalo", "ivete", "sangalo",
	// "roberto carlos", "cazuza", "cassia eller", "cassia", "eller",
	// "paula fernandes", "zizi possi", "zizi", "possi", "simone",
	// "gusttavo lima", "gusttavo", "lima", "tim maia", "maia", "lisa ono",
	// "maria bethania", "bethania", "adriana calcanhotto", "adriana",
	// "calcanhotto", "astrud gilberto", "astrud", "bebel gilberto", "gilberto",
	// "bebel", "max cavalera", "cavalera", "luan santana", "luan", "gal costa",
	// "daniela mercury", "seu jorge", "ana carolina", "carolina", "ivan lins",
	// "martinho da vila", "martinho", "raul seixas", "seixas",
	// "claudia leitte", "leitte", "samuel rosa", "jorge ben jor",
	// "zeze di camargo", "zeze", "camargo", "sergio mendes", "moraes moreira",
	// "moraes", "moreira", "roberta sa", "dinho", "joanna",
	// "oswaldo montenegro", "oswaldo", "montenegro", "jesse", "edu falaschi",
	// "falaschi", "carlinhos brown", "carlinhos", "djavan", "vanessa da mata",
	// "da mata", "nara leao", "nara", "leao", "geraldo vandre", "vandre",
	// "mano brown", "tom ze", "jorge aragao", "aragao", "dick farney",
	// "carney", "psirico", "valesca popzuda", "valesca", "popzuda",
	// "lucas lucco", "lucco", "shakira", "claudia leitte", "leitte",
	// "fernando", "sorocaba", "jason derulo", "derulo", "henrique", "juliano",
	// "bastille", "gusttavo lima", "cristiano araujo", "gusttavo", "araujo",
	// "fernandes", "maria cecilia", "cecilia", "rodolfo", "luan santana",
	// "anitta", "zeze di camargo", "zeze", "camargo", "sorriso maroto",
	// "sorriso", "maroto", "marrone", "ricardo", "joao", "guilherme",
	// "naldo benny", "naldo", "benny", "ivete sangalo", "ivete",
	// "turma do pagode", "turma", "pagode", "sorriso maroto", "sorriso",
	// "maroto", "thiaguinho", "martin garrix", "garrix", "sorocaba",
	// "gusttavo", "lima", "bruno", "sorriso maroto", "moroto", "sorriso",
	// "thiaguinho", "michel telo", "anitta", "santana", "mateus",
	// "cesar menotti", "menotti", "fabiano", "gabriel valim", "valim",
	// "michel telo", "telo", "detonautas", "lucas lucco", "lucco"};
	...
	public static String getDefaultValueForRemoteSettingIfSet(String property) {
		...
		if (property.equals(KEY_REMOTE_SETTING_IS_ARTIST_SEARCH_ENABLED)) {
			...
			// value =
			// "{\"title\":\"kasha\", \"description\": \"yarrrgh lol\", \"package\": \"brain.age.analyzer\", \"ok_button_message\": \"okie\", \"cancel_button_message\": \"narr\", \"max_times_shown\": 20}";
		} else if (property.equals(KEY_REMOTE_SETTING_GRABOS_DIRECT_INTERSTITIAL)) {
			value = "{\"title\":\"\", \"package\": \"\", \"max_times_shown\": 5}";
			// value =
			// "{\"title\":\"berry\", \"package\": \"com.helloworld.android\", \"max_times_shown\": 20}";
			...
			// value =
			// "[{grabos:2}, {grabos_direct:2}, {mobilecore_stickeez:2}, {mobilecore:0}]";
			...
			value = "[]"; // value =
							// "[{appbrain:2}, {appnext:1}, {mobilecore:0}]";,
							// //"[{grabos_direct:1},{grabos:1}, {mobilecore:0}]";
	...
	// this method tries to return remote search_engines if it exists,
	// otherwise, it returns the default search egnines (SEARCH_ENGINES)
	...
	public static String getRemoteSetting(Context context, String property, String defaultValue) {
		...
		try {
			// String value = AppBrain.getSettings().get(property,
			// defaultValue);
	...
	public static void updateSettingsAsyncTask(Context context, String serverUrl, int minUpdateIntervalMillis, int connectionTimeoutMillis, int socketTimeoutMillis) {
		try {
	...
	public static void updateSettingsSynchronousTask(Context context, String serverUrl, int minUpdateIntervalMillis, int connectionTimeoutMillis, int socketTimeoutMillis) {
		if (serverUrl != null && !serverUrl.equals("")) {
					...
					if (serverUrl != null) {
						...
						try {
							...
							if (statusCode >= 300) {
								...
								// we consider the request a success if we get
								// to this point, so we will save it
								...
								if (entity != null) {
									...
									try {
										...
										// combine all the lines into a single
										// string
	...
	public static boolean getIsBlacklistedIP(Context ctx) {
		...
		if (isBlacklistedIPString == null || isBlacklistedIPString.equals("false"))
			return false;
		else
			return true;
	...
	public static boolean getIsBlacklistedLocation(Context ctx) {
		...
		if (isBlacklistedLocationString == null || isBlacklistedLocationString.equals("false"))
			return false;
		else
			return true;
	...
	public static String KEY_REMOTE_SETTING_INTERSTITIAL_START = "interstitial_start";
