...
public class LibraryPageAdapter extends ArrayAdapter<MusicData> implements
	TextWatcher {
    ...
    public LibraryPageAdapter(Context context, int resource,
	    ArrayList<MusicData> arrayMusic, MainActivity activity) {
	...
	if (convertView == null) {
	    ...
	    holder.hThreedot = (Button) convertView
		    .findViewById(R.id.threedotButton);
	    holder.hButtonPlay = (ImageButton) convertView
		    .findViewById(R.id.play_song);
	    holder.hSongTitle = (TextView) convertView
		    .findViewById(R.id.title_song);
	    holder.hSongGenre = (TextView) convertView
		    .findViewById(R.id.genre_song);
	    holder.hCoverImage = (ImageView) convertView
		    .findViewById(R.id.cover_song);
	    holder.hSongDuration = (TextView) convertView
		    .findViewById(R.id.duration_song);
	...
	holder.hButtonPlay.setOnClickListener(new OnClickListener() {
		...
		activity.play(strPath, strArtist, strTitle, strDuration,
			PrefKeys.CALL_FROM_LIBRARY, pos);
	    }
	...
	getFilter().filter(
		filter.getText().toString().toLowerCase(Locale.ENGLISH));
    }
