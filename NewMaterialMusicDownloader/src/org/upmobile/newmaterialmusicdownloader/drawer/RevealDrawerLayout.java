...
public class RevealDrawerLayout extends DrawerLayout implements DrawerLayout.DrawerListener {
    ...
    private void setDrawerReveal(int gravity,
                                 View drawerView,
                                 float slideOffset) {
        drawerView.setTranslationX((((gravity == Gravity.LEFT) ? drawerView.getWidth() : -drawerView.getWidth())
                + ((gravity == Gravity.LEFT) ? mListOffset : -mListOffset)) * (1 - slideOffset));
    ...
    private void setCenter(int gravity,
                           float centerX,
                           float centerY) {
        switch (gravity) {
            case Gravity.LEFT:
    ...
    private void setRevealRadius(int gravity,
                                 float revealRadius) {
        switch (gravity) {
            case Gravity.LEFT:
    ...
    private static float calcRevealRadius(float revealY,
                                          int width,
                                          int height) {
