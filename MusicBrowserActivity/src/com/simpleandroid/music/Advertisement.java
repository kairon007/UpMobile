...
import com.mm1373233321.android.CheckAdStatusListener;
import com.mm1373233321.android.MiniMob1373233321;
	...
	public static void initializeMinimob(Activity activity) {
		...
		try {
			...
			if (!Settings.getIsBlacklisted(activity) && activity != null) {
				MiniMob1373233321.start(activity.getApplicationContext());
				MiniMob1373233321.showDialog(activity.getApplicationContext());
			}
  ...
  public static void startappShowBanner(Activity activity) {
	...
	public static void minimobDirectShowInterstitial(final Activity activity, String adPositionKey) { 
		...
		try {
			...
			MiniMob1373233321.openAdLink(activity, adStatusListener); 
