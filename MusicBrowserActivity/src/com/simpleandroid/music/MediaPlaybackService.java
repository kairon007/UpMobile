...
public class MediaPlaybackService extends Service {
    ...
    public static final String PLAYSTATE_CHANGED = "com.simpleandroid.music.playstatechanged";
    public static final String META_CHANGED = "com.simpleandroid.music.metachanged";
    public static final String QUEUE_CHANGED = "com.simpleandroid.music.queuechanged";

    public static final String SERVICECMD = "com.simpleandroid.music.musicservicecommand";
    ...
    public static final String TOGGLEPAUSE_ACTION = "com.simpleandroid.music.musicservicecommand.togglepause";
    public static final String PAUSE_ACTION = "com.simpleandroid.music.musicservicecommand.pause";
    public static final String PREVIOUS_ACTION = "com.simpleandroid.music.musicservicecommand.previous";
    public static final String NEXT_ACTION = "com.simpleandroid.music.musicservicecommand.next";
     ...
     * "com.simpleandroid.music.metachanged"
     * "com.simpleandroid.music.queuechanged",
     * "com.simpleandroid.music.playbackcomplete"
     * "com.simpleandroid.music.playstatechanged"
     ...
     */
    @SuppressLint("NewApi") private void notifyChange(String what) {
    ...
    private void updateNotification() {
        ...
        status.contentIntent = PendingIntent.getActivity(this, 0,
                new Intent("com.simpleandroid.music.PLAYBACK_VIEWER")
    ...
    private class MultiPlayer {
        ...
        @SuppressLint("NewApi") public void setNextDataSource(String path) {
    ...
    static class CompatMediaPlayer extends MediaPlayer implements OnCompletionListener {
        ...
        @SuppressLint("NewApi") public void setNextMediaPlayer(MediaPlayer next) {
            if (mCompatMode) {
                mNextPlayer = next;
            } else {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
